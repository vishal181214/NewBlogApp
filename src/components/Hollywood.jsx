                    ...
                    <>
                        ...
                        <div className="mainContent">
                            <div className="firstContent">
                                <Link to='/HollyImgFirst'>
                                <div className="hollyImgText">
                            ...
                            <div className="secContent">
                                <div className="infoCard">
                                    <Link to='/HollyImgFour'><div className="hollyimage"></div></Link>
                            ...
                            <div className="theLatest technoLattechnoLat hollyalgn">
                                <p>{props.articles}</p>
                                <hr />
                            </div>
                            <div className="latestArt">
                                <div className="leftArticle">
                                    ...
                                    <div className="wavesBlock">
                                        <Link to='/HollyImgThree'><div className="hollywaveImg"></div></Link>
                                    ...
                                    <hr />
                                    <div className="wavesBlock">
                                        <Link to='/ImageInfo'><div className="hollywaveImg"></div></Link>
                                        <div className="waveText">
                                            <p className='waveTextHeading'>{props.waveHeading}<br />{props.waveHeadingBr}</p>
                                            <p className='waveTextInfo'>{props.waveTextInfo}<br />{props.waveTextInfoBr}</p>
                                            <p className='travAlgn'><span className='travel'>{props.travel}</span><span className='dateInfo'> {props.travelDate}</span></p>
                                    ...
                                    <Link to='/ImageHollyImgFirstInfo'>
                                    <div className="hollygalleryImg">
                                ...
                                <div className="rightArticle alignright">
                                    ...
                                    <div className="topPost">
                                        ...
                                        <p className='hey'></p>
                                        <Link to='/HollyImgFirst'><div className='hollytopImage'></div></Link>
                                        ...
                                        <div className="topTextOne">
                                            <Link to='/HollyImgFirst'><div className="hollytopTextImg"></div></Link>
