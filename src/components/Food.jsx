                    ...
                    <>
                        ...
                        <div className="mainContent">
                            <div className="firstContent">
                                <Link to='/FoodImgFirst'>
                                <div className="FoodImgText">
                            ...
                            <div className="FitsecContent">
                                <div className="FinfoCard">
                                    <Link to='/FoodImgTwo'><div className="Foodimage"></div></Link>
                                ...
                                <div className="FinfoCard foogap">
                                    <Link to='/FoodImgTwo'><div className="Foodimage"></div></Link>
                                    <div className="imageText">
                                        <p className='imageTitle'>{props.imgCardTitle}<br />{props.imgCardTitleBr}</p>
                                        <p className='imgDesc'>{props.imgCardInfo}</p>
                                ...
                                <div className="FinfoCard algn foogap">
                                    <Link to='/FoodImgTwo'><div className="Foodimage"></div></Link>
                                    <div className="imageText">
                                        <p className='imageTitle'>{props.imgCardTitle}<br />{props.imgCardTitleBr}</p>
                                        <p className='imgDesc'>{props.imgCardInfo}</p>
                            ...
                            <div className="latestArt">
                                ...
                                <div className="rightArticle alignright">
                                    ...
                                    <div className="topPost">
                                        ...
                                        <p className='hey'></p>
                                        <Link to='/FoodImgThree'><div className='FoodtopImage'></div></Link>
                                        ...
                                        <div className="topTextOne">
                                            <Link to='/FoodImgThree'><div className="FoodtopTextImg"></div></Link>
