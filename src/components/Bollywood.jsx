                ...
                return(
                    ...
                    <div className="mainContent">
                        <div className="firstContent">
                            <Link to='/BollyImgFirst'>
                            <div className="bollyImgText">
                        ...
                        <div className="BollysecContent">
                            <div className="BinfoCard">
                                <Link to='/BollyImgThree'><div className="Bollyimage"></div></Link>
                                <div className="imageText BollyItext">
                        ...
                        <div className="latestArt">
                            <div className="leftArticle">
                                ...
                                <div className="wavesBlock">
                                    <Link to='/BollyImgFour'><div className="BollywaveImg"></div></Link>
                                ...
                                <Link to='/BollyImgTwo'>
                                <div className="BollygalleryImg">
                                    <p className='gallTitle'>{props.galleryHead}</p>
                            ...
                            <div className="rightArticle alignright">
                                ...
                                <div className="topPost">
                                    ...
                                    <p className='hey'></p>
                                    <Link to='/BollyImgFive'><div className='BollytopImage'></div></Link>
                                    ...
                                    <div className="topTextOne">
                                        <Link to='/BollyImgFive'><div className="BollytopTextImg"></div></Link>
                                        <div className="bltextOne hrxaln">
                                            <p className="BtopTitle">{props.topTitle}<br />{props.topTitleBr}</p>
                                            <p className='trav'><span className='travel'>{props.travel}</span><span className='dateInfo'> {props.travelDate}</span></p>
                                        </div>
                                        <div className="num hrxaln">
                                            <p>{props.two}</p>
                                        </div>
                                    </div>
                                    <hr />
